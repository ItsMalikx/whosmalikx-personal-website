...
*   **`privacy.html`**: The standard privacy policy page.
*   **`assets/`**: Contains all static files:
    *   `css/style.css`: All styling for the website.
    *   `js/`: Small, single-purpose JavaScript files for site enhancements.
        *   `theme.js`: Manages the light/dark mode theme toggling.
        *   `dynamic-date.js`: Updates the copyright year automatically.
